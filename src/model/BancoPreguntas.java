        ...
        static {
                ...
                banco.put("digitalizacion", new ArrayList<>(List.of(
                                ...
                                new Pregunta("¿Qué tecnología superpone objetos virtuales al mundo real?",
                                                "Realidad Virtual (VR)",
                                                "Realidad Aumentada", "Metaverso", "Cloud Computing", 2))));
                ...
                banco.put("sistemas", new ArrayList<>(List.of(
                                new Pregunta("¿Qué es un sistema operativo?", "Administra hardware",
                                ...
                                new Pregunta("¿Qué es un servidor?", "Provee servicios",
                                ...
                                new Pregunta("¿Qué es una base de datos?", "Un lenguaje", "Un compilador",
                                                "Organiza datos", "Un IDE", 3),
                                new Pregunta("¿Qué es un firewall?", "Un antivirus",
                                                "Filtra tráfico de red",
                                                "Un IDE", "Una variable", 2),
                                new Pregunta("¿Qué es virtualización?", "Crea máquinas virtuales", "Instalar Linux",
                                                "Actualizar Windows", "Programar en Java", 1),
                                new Pregunta("¿Qué es RAID?", "Array de discos", "Un lenguaje",
                ...
                banco.put("sostenibilidad", new ArrayList<>(List.of(
                                ...
                                new Pregunta("¿Qué es reciclaje?",
                                                ...
                                                "Procesar residuos para reusarlos",
